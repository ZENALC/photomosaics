...
class PhotoMosaic:
    def __init__(self, imageFile, imagesFolder, step=100, targetWidth=12500):
        ...
        self.pixels = list(self.image.getdata())  # get list of RGB values from image
    ...
    def get_image(self, path: str, dimension: tuple = None, squareImage: bool = False, resize: bool = False) -> Image:
    ...
    def load_images(self, path: str, dimension: tuple = None) -> dict:
        ...
        for file in os.listdir():
            if not file.lower().endswith(('.png', '.jpg', '.jpeg')):
                continue
            image = self.get_image(file, dimension=dimension, squareImage=True)
...
if __name__ == "__main__":
    a = PhotoMosaic('monkey.jpg', 'Random Images', targetWidth=15000, step=200)
    a.save_image()
